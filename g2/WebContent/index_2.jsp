...
<body onload="javascript:openPopup('popup.html')">
 <header class="" id="header">
    ...
    <!-- <div class="wrapper"> -->
       ...
       <div id="sb">
        ...
        <nav class="">
            ...
            <div>
                <a class="sb_it sb_i2" href="sights/sights_script.jsp">
                    <button class="sb_btn">
                        <div class=""></div>
    ...
    <!-- 왼쪽사이드바 로고 5개 끝 -->
         ...
         <div id="mainFrm">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                  ...
                  <img src="img/background1.png" style="width:100%">
                  <div class="text">어디였지</div>
                </div>
          
                <div class="mySlides fade">
                  
                  <img src="img/background2.png" style="width:100%">
                  <div class="text">꽃밭</div>
                </div>
          
                <div class="mySlides fade">
              
                  <img src="img/background3.png" style="width:100%">
                  <div class="text">농장</div>
                </div>
          
                <div class="mySlides fade">
                
                  <img src="img/background4.png" style="width:100%">
                  <div class="text">눈내린 한라산</div>
                </div>
          
                <div class="mySlides fade">
                
                  <img src="img/background5.png" style="width:100%">
                  <div class="text">박물관</div>
                </div>
          
                <div class="mySlides fade">
                 
                  <img src="img/background6.png" style="width:100%">
                  <div class="text">돌하르방</div>
                </div>
            </br>
         ...
         <div class="content2">
            <div class="mn_ct">
                <img src="img/background1.png" width="40%" height="240px">
                <img src="img/background1.png" width="40%" height="240px">
            </div>
